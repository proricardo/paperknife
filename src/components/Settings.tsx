      ...
      <div className="animate-in fade-in slide-in-from-bottom-2 duration-500 pb-40">
        ...
        <div className="flex items-center gap-4 px-2 mb-8 mt-2">
           ...
           <div>
              ...
              <p className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Protocol v1.0.6 • Local</p>
           </div>
        </div>
        ...
        <div className="mt-12">
           ...
           <p className="text-[8px] font-black uppercase text-center text-gray-300 dark:text-zinc-700 tracking-[0.5em] mt-10">Configuration Engine v1.0.6 Stable</p>
        </div>
