...
export default function WatermarkTool() {
  ...
  return (
    <NativeToolLayout title="Watermark" description="Add secure text overlays to your documents locally." icon={Type} actions={pdfData && !pdfData.isLocked && !downloadUrl && <ActionButton />}>
