...
export default function RotateTool() {
  ...
  return (
    <NativeToolLayout title="Rotate PDF" description="Fix page orientation permanently. Processed locally." actions={pdfData && !pdfData.isLocked && !downloadUrl && <ActionButton />}>
