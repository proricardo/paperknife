...
import { Download, Loader2, CheckCircle2, RotateCw, Lock, RefreshCcw, Eye } from 'lucide-react'
    ...
    <div className="flex-1">
      <main className="max-w-6xl mx-auto px-6 py-6 md:py-10">
        <div className="text-center mb-8 md:mb-12">
          <h2 className="text-3xl md:text-5xl font-black mb-3 md:mb-4 dark:text-white">Rotate <span className="text-rose-500">PDF.</span></h2>
          <p className="text-sm md:text-base text-gray-500 dark:text-zinc-400">Fix page orientation permanently. <br className="hidden md:block"/>Processed locally.</p>
        </div>
                ...
                <div className="space-y-6">
                  ...
                  {!downloadUrl ? (
                    ...
                    <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-300">
                      ...
                      <button onClick={() => setDownloadUrl(null)} className="w-full py-2 text-xs font-black uppercase text-gray-400 hover:text-rose-500 tracking-[0.2em]">Edit Again</button>
                    </div>
                  )}
