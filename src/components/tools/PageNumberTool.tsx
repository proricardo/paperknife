...
export default function PageNumberTool() {
  ...
  return (
    <NativeToolLayout title="Page Numbers" description="Add custom numbering to your PDF automatically." icon={Hash} actions={pdfData && !pdfData.isLocked && !downloadUrl && <ActionButton />}>
